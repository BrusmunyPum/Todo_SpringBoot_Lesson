...
public class UserDetailResponse {
    ...
    public UserDetailResponse(Long id, String username, String email, Long taskCount, Instant createdAt, Instant updatedAt) {
        this.id = id; this.username = username; this.email = email; this.taskCount = taskCount; this.createdAt = createdAt; this.updatedAt = updatedAt;
    }
    // Add standard getters for all fields here...
